...
title: Reflected XSS in /ajax/deletemultiple
---

# Deletemultiple - Reflected Cross-Site-Scripting via "files" parameter manipulation
...
The weakness was disclosed 04/06/2020 by Alessandro Magnosi (deadc0de) (GitHub Repository). It is possible to read the advisory at github.com. This vulnerability is known as CVE-2020-11702. The attack can be launched remotely. The exploitation needs a single authentication. Technical details of the vulnerability are known, but there is no available exploit.
